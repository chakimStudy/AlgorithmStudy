...
class Solution {
	...
	private static boolean run(int m, Scanner sc) throws IOException {
	...
	public static void main(String[] args) throws Exception {
		...
		System.setIn(new java.io.FileInputStream("C:\\Users\\whwhd\\OneDrive\\바탕 화면\\sy\\ProblemSolve\\StudyProject\\src\\B형대비_pro\\SWEA_Pro_1_오타교정시스템\\input11.txt"));
